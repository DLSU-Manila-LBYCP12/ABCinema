 ...
 */
public class TYACars extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cinema.setText("Teresa Yuchenco Audithorium     12:30PM");
        ...
        posterDespicalbleMe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posters/posterCars3.png"))); // NOI18N
        ...
        DespicalbleMe.setText("CARS 3");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttonRating/labelG.png"))); // NOI18N
        ...
        ticketDetails1.setText("Theresa Yuchenco Audithorium");
    ...
    private void buttonContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonContinueActionPerformed
        ...
        else if(D3.isSelected()==true){
                D3.setEnabled(false);
                seatListDM.reserveSeats(33);
        }
        else if(D4.isSelected()==true){
                D4.setEnabled(false);
                seatListDM.reserveSeats(34);
        }
        else if(D5.isSelected()==true){
                D5.setEnabled(false);
                seatListDM.reserveSeats(35);
        }
        else if(D6.isSelected()==true){
                D6.setEnabled(false);
                seatListDM.reserveSeats(36);
        }
        else if(D7.isSelected()==true){
                D7.setEnabled(false);
                seatListDM.reserveSeats(37);
        }
        else if(D8.isSelected()==true){
                D8.setEnabled(false);
               seatListDM.reserveSeats(38);
        }
        else if(D9.isSelected()==true){
                D9.setEnabled(false);
                seatListDM.reserveSeats(39);
        }
        else if(D10.isSelected()==true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TYACars.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
